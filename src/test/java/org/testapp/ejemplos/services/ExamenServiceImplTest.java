...
import static org.testapp.ejemplos.services.Data.EXAMS;
...
//        service = new ExamenServiceImpl(repository, preguntaRepository);
    ...
    void testGuardarExamen() {
        ...
        when(repository.guardar(any(Examen.class))).then(new Answer<Examen>(){
            ...
            Long secuencia = 8L;
//Asigna el Id manualmente desde 8L cada que se ejecuta guardar se llama este metodo y se incrementa el id
            //lo que hace es devolver un objeto con un id diferente de null no hace mas
            @Override
